...
![New-Habit](doc-images/New-Habit.png)
...
* PostgreSQL Database  
  * POSTGRES\_PASS, DATABASE\_URL  
* DigitalOcean Spaces  
  * DO\_SPACES\_KEY, DO\_SPACES\_SECRET, DO\_SPACES\_REGION, DO\_SPACES\_BUCKET  
* Pusher API  
  * PUSHER\_APP\_ID, PUSHER\_KEY, PUSHER\_SECRET, PUSHER\_CLUSTER  
* Auth  
  * JWT\_SECRET
...
5. Using the chosen bucket name, region and generated key values fill out the following values in the .env file:  
   1. DO\_SPACES\_KEY, DO\_SPACES\_SECRET, DO\_SPACES\_REGION, DO\_SPACES\_BUCKET
